...
\begin{tabular}{@{}lrl@{}}
\toprule
Project & usable/supp. & Dominant loss cause \\
\midrule
black & 26/34 & env build (some commits) \\
pandas & 23/34 & C-ext.\ build (some commits) \\
salt & 3/7 & dependency resolution \\
discord.py & 1/2 & env build \\
cookiecutter, scrapy & 2/2 & --- \\
jax & 0/13 & test-suite timeouts \\
freqtrade & 0/12 & dependency builds \\
poetry & 0/8 & pipx/poetry toolchain \\
spaCy & 0/4 & Cython builds \\
\midrule
total & 55/116 & \\
\bottomrule
\end{tabular}
...
\begin{tabular}{@{}lrrr@{}}
\toprule
 & baseline & struct.\ (normal) & struct.\ (planted) \\
\midrule
...
\midrule
black-232 & converted & no (sibling 297) & pilot: converted \\
black-273 & converted & no (sibling 297) & pilot: converted \\
black-297 & converted & yes & pilot: converted \\
pandas-14973 & converted & yes & \\
black-95, -238, -334 & regressed & yes & applied, tests fail \\
pandas-14652, -14770 & regressed & yes & applied, tests fail \\
pandas-14776, -15488 & regressed & yes & applied, tests fail \\
\bottomrule
\end{tabular}
\end{table}
